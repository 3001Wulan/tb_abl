            ...
            <div class="w-full max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 border border-gray-100 dark:border-gray-600">
                ...
                <form id="editLogbookForm" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <label for="file_kegiatan" class="flex flex-col items-center justify-center w-full h-44 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 transition">
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                                            ...
                                            <p id="file-name-display" class="mb-2 text-sm text-gray-500 dark:text-gray-400 font-medium text-center">Memuat informasi file...</p>
                                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <textarea name="deskripsi_kegiatan" id="deskripsi_kegiatan" required
                                      class="w-full flex-grow px-4 py-2 rounded-lg border dark:bg-gray-700 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 outline-none transition min-h-[200px] md:min-h-full"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end space-x-4 mt-8 pt-6 border-t dark:border-gray-700">
                        ...
                        <button type="submit" id="btnSubmit" class="px-10 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 shadow-lg transition font-bold">Update Logbook</button>
                    </div>
                </form>
            </div>
        </div>
...
function previewFileName(input) {
    ...
    if (input.files.length > 0) {
        display.innerHTML = `<span class="text-blue-600 font-bold text-sm">File baru: ${input.files[0].name}</span>`;
        icon.classList.add('text-blue-500');
    }
}

function setup() {
    return { isDark: localStorage.getItem('dark') === 'true', toggleTheme() { this.isDark = !this.isDark; localStorage.setItem('dark', this.isDark); } }
}
</script>
</body>
</html>